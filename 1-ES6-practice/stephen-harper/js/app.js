...
function displayPics(){
  ...
  // If var changed to let, it creates an error because let's scope is only in the block for which it is defined, including other sub-blocks so when pushed to viewed, it causes an error. The difference is the scope of var is on the entire enclosing function.
  console.log(viewed);
